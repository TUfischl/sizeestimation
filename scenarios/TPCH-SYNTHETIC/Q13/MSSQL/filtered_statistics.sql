...
DROP STATISTICS LINEITEM.LINEITEM_l_linenumber;
DROP STATISTICS LINEITEM.LINEITEM_l_orderkey
DROP STATISTICS LINEITEM.LINEITEM_l_partkey
DROP STATISTICS LINEITEM.LINEITEM_l_shipdate
DROP STATISTICS LINEITEM.LINEITEM_l_suppkey
DROP STATISTICS LINEITEM.LINEITEM_ALL
DROP STATISTICS customer.customer_c_acctbal
DROP STATISTICS part.part_p_partkey
DROP STATISTICS orders.orders_o_orderkey;
DROP STATISTICS orders.orders_o_orderdate;
DROP STATISTICS orders.orders_ALL;
