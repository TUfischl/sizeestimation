CREATE VIEW v1 AS (
SELECT A0.l_linenumber
FROM lineitem AS A0
WHERE A0.l_shipdate=A0.l_commitdate AND A0.l_returnflag='N' AND A0.l_linestatus='O' AND A0.l_shipinstruct='TAKE BACK RETURN'
);
...
CREATE VIEW v2 AS (
SELECT A0.o_orderkey,A2.l_linenumber,A1.p_partkey
