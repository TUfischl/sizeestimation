CREATE VIEW v11 AS (
SELECT A0.o_orderkey,A1.l_linenumber
...
CREATE VIEW v12 AS (
SELECT A0.l_orderkey,A0.l_linenumber,A0.l_partkey
...
CREATE VIEW v21 AS (
SELECT A0.s_suppkey,A0.s_nationkey
...
CREATE VIEW v22 AS (
SELECT A0.s_suppkey,A1.c_custkey
